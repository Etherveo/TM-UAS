...
const charData = {
    gold: {
        theme: 'gold', color: '#D4AF37', bg: '#F9F3E0', img: '../pictures/si_hulawa.png', mant: "../pictures/gold-mantel.png",
    ...
    white: {
        theme: 'white', color: '#333', bg: '#dde1e7', img: '../pictures/putih.png', mant: "../pictures/gold-mantel.png",
    ...
    red: {
        theme: 'red', color: '#C0392B', bg: '#EADBD9', img: '../pictures/merah.png', mant: "../pictures/gold-mantel.png",
...
function loadContent(theme) {
    ...
    elementsFragment.querySelector('.col-img-face').src = data.mant;
